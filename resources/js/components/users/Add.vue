                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="user_type" v-model="formData.user_type" v-on:keyup.enter="create">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" v-model="formData.name" v-on:keyup.enter="create">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="email" v-model="formData.email" v-on:keyup.enter="create">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" v-model="formData.password" v-on:keyup.enter="create">
                            ...
                            <div class="col-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmation" v-model="formData.password_confirmation" v-on:keyup.enter="create">
